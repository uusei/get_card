...
"")
        ...
        self.target_card.setMaximumSize(QtCore.QSize(250, 375))
...
"border-image: none;")
        ...
        self.screen.setGeometry(QtCore.QRect(0, 0, 800, 500))
        self.screen.setMinimumSize(QtCore.QSize(800, 500))
        self.screen.setMaximumSize(QtCore.QSize(1920, 1080))
        self.screen.setText("")
        self.screen.setAlignment(QtCore.Qt.AlignCenter)
        self.screen.setObjectName("screen")
        self.pushButton = QtWidgets.QPushButton(Form)
        self.pushButton.setEnabled(False)
        self.pushButton.setGeometry(QtCore.QRect(240, 390, 291, 91))
