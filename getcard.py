...
"}")
        ...
        self.label_3.setMinimumSize(QtCore.QSize(120, 300))
        self.label_3.setMaximumSize(QtCore.QSize(120, 300))
        self.label_3.setStyleSheet("border-image: url(:/image/mizugi_aqua.gif);")
        self.label_3.setText("")
        self.label_3.setObjectName("label_3")
        self.verticalLayout_2.addWidget(self.label_3)
        self.horizontalLayout_2.addLayout(self.verticalLayout_2)
        self.screenfull = QtWidgets.QLabel(self.centralwidget)
        self.screenfull.setMinimumSize(QtCore.QSize(650, 400))
        self.screenfull.setMaximumSize(QtCore.QSize(1706, 960))
        self.screenfull.setStyleSheet("border: 3px solid #ff9292;\n"
"border-radius: 8px;\n"
"border-image: none;")
        self.screenfull.setText("")
        self.screenfull.setAlignment(QtCore.Qt.AlignCenter)
        self.screenfull.setObjectName("screenfull")
        self.horizontalLayout_2.addWidget(self.screenfull)
